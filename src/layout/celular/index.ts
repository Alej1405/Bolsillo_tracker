/*
  ...
  reescribe los formularios — importa los de '@/paginas/acceso', los mismos que usa
  escritorio, y solo cambia el envoltorio.

  Lo que se comparte con escritorio NO entra aquí: las piezas del UI Kit siguen
  en '@/piezas' y los datos en '@/datos'.
*/
export { AppCelular } from '@/layout/celular/AppCelular'
