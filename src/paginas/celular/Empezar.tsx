...
import { BotonIr } from '@/ui/BotonIr'
      ...
      */}
      ...
      >
        ...
        <input
          ...
          className="h-[52px] w-full rounded-grande bg-fondo-superficie px-4 text-cuerpo-medio text-texto-principal outline-none placeholder:text-texto-tenue focus:ring-2 focus:ring-lavanda-700"
        />
